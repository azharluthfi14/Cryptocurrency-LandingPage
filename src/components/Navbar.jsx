...
const Navbar = () => {
    ...
    return (
        <nav className="fixed w-full z-10 bg-slate-900 top-0 px-2 py-3.5">
            <div className="container flex flex-wrap justify-between items-center mx-auto">
                ...
                <div className="flex items-center gap-x-3.5 md:order-2">
                    <button type="button" data-mdb-ripple="true"
                        data-mdb-ripple-color="primary" className="
                       inline-block px-7 py-2.5 border border-blue-400  text-blue-400  font-medium text-base leading-tight rounded-full hover:bg-black hover:bg-opacity-5 focus:outline-none focus:ring-0 transition duration-150 ease-in-out
                    ">Log In</button>
                    <button type="button" data-mdb-ripple="true"
